...
class TEXT2TOSSAPITester:
    ...
    def test_stripe_removal_and_venmo_only_system(self):
        ...
        payment_request = {
            ...
            "origin_url": "https://quote-status-pending.preview.emergentagent.com"
        }
    ...
    def test_photo_url_diagnosis(self):
        ...
        backend_url = "https://quote-status-pending.preview.emergentagent.com"
        ...
        print(f"   🌐 Expected backend URL: https://quote-status-pending.preview.emergentagent.com")
        ...
        print(f"   • Backend URL: https://quote-status-pending.preview.emergentagent.com")
