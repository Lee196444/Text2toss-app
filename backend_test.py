...
class TEXT2TOSSAPITester:
    def __init__(self, base_url="https://junkapp.preview.emergentagent.com"):
    ...
    def test_stripe_removal_and_venmo_only_system(self):
        ...
        payment_request = {
            ...
            "origin_url": "https://junkapp.preview.emergentagent.com"
        }
    ...
    def test_photo_url_diagnosis(self):
        ...
        backend_url = "https://junkapp.preview.emergentagent.com"
        ...
        print(f"   🌐 Expected backend URL: https://junkapp.preview.emergentagent.com")
        ...
        print(f"   • Backend URL: https://junkapp.preview.emergentagent.com")
